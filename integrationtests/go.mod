module github.com/junioryono/godi/integrationtests
...
replace github.com/junioryono/godi/huma/v5 => ../huma

replace github.com/junioryono/godi/chi/v5 => ../chi

replace github.com/junioryono/godi/echo/v5 => ../echo
