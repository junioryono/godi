...
// NewManager creates a new lifetime manager.
...
// NewManagerWithOptions creates a new lifetime manager with options.
func NewManagerWithOptions(onDispose func(instance any, err error)) *Manager {
	return &Manager{
		singletons: make(map[instanceKey]*managedInstance),
		scopes:     make(map[string]*ManagedScope),
		onDispose:  onDispose,
